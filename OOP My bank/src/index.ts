...
interface Account {
    ...
    age: number;
    phoneNumber: number;
    accountPasskey: string;
    balance: number;
}
let bankDatabase: any = [];
class Bank_Account implements Account {
    constructor(public firstName: string, public lastName: string, public gender: string, public age: number, public phoneNumber: number, public accountPasskey: string, public balance: number) {
...
async function query() {
    ...
    if(userOptions === "Check status") {
        ...
        if (userInfo.confirmCreation) {
            ...
            //     });
            // }
        } else { console.log("No account can be created") }
    }
